...
public class TransCycle extends AbstractEntity implements Trans{
    ...
    public Long getEquipIdTrans() {
        Long equipId = Long.valueOf(haulId);
        return equipId;
    }

    @Override
    public Calendar getTime() {
        return GregorianCalendar.from(ZonedDateTime.ofInstant(endTime, ZoneId.systemDefault()));
    }
}